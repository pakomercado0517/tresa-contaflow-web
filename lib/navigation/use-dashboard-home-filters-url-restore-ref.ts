...
import { tryRestoreDashboardHomeFiltersInUrl } from '@/lib/navigation/dashboard-filters-url';

export function useDashboardHomeFiltersUrlRestoreRef(
  pathname: string,
  profiles: Profile[]
) {
  ...
  return useCallback(
    (node: HTMLDivElement | null) => {
      ...
      tryRestoreDashboardHomeFiltersInUrl({
        searchParams,
        profiles,
        router,
        pathname,
