...
export function UploadExpensesContent({ profiles }: UploadExpensesContentProps) {
  ...
  const handleProcess = async () => {
    ...
    console.log("Procesando archivos de gastos:", validFiles);
    
    // Simular procesamiento
    setTimeout(() => {
      setIsProcessing(false);
      alert("Gastos procesados exitosamente");
      setQueuedFiles([]);
    }, 2000);
  };
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Sube tus archivos CFDI de gastos para validación y procesamiento automático.
